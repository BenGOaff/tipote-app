...
export const SEED_CATEGORIES: SeedCategory[] = [
  ...
  },
  {
    ...
    description: {
      fr: "Gérez vos leads, exportez-les et synchronisez avec Tipote Business",
      en: "Manage your leads, export them and sync with Tipote Business",
      es: "Gestiona tus leads, expórtalos y sincroniza con Tipote Business",
      it: "Gestisci i tuoi lead, esportali e sincronizza con Tipote Business",
      ar: "إدارة العملاء المحتملين وتصديرهم ومزامنتهم مع Tipote Business",
    },
  },
  {
...
| 📄 | **Templates** | Templates Tipote Business |
...
- **Templates** — Tipote Business templates
...
- Configuration **API Tipote Business**
...
5. **Copiez** le résultat dans votre outil d'emailing (Tipote Business, Mailchimp, etc.)
...
> **Voir aussi :** [Hub de création](/support/article/create-content-overview) • [Templates Tipote Business](/support/article/systemeio-templates)`,
...
4. **Utilisez** le contenu généré dans vos outils (Tipote Business, etc.)
...
- **URL de paiement** — Lien vers votre page de paiement (Tipote Business, Stripe...)
...
### Synchronisation Tipote Business

Vous pouvez **synchroniser les leads** de vos quiz directement vers votre compte Tipote Business avec les tags de votre choix.

> **Voir aussi :** [Créer une page](/support/article/create-page) • [Gérer vos leads](/support/article/manage-leads) • [Intégration Tipote Business](/support/article/systemeio-integration)`,
...
Captures email + name before showing results. Auto-syncs to Tipote Business.
...
| 🔄 Tipote Business | Exporté oui/non |
...
- Statut d'export Tipote Business
...
- 🔄 **Exportés Tipote Business** — Synchronisés
...
> **Voir aussi :** [Intégration Tipote Business](/support/article/systemeio-integration) • [Créer un quiz](/support/article/create-quiz) • [Créer une page](/support/article/create-page)`,
...
> **See also:** [Tipote Business integration](/support/article/systemeio-integration) • [Create a quiz](/support/article/create-quiz)`,
...
جميع العملاء المحتملين المسجلين مركزيون في **العملاء المحتملون**. بحث وفلاتر وتصدير CSV وتشفير AES-256.`,
  ...
  },
  {
    ...
    sort_order: 2,
    title: {
      fr: "Intégration Tipote Business",
      en: "Tipote Business integration",
      es: "Integración Tipote Business",
      it: "Integrazione Tipote Business",
      ar: "تكامل Tipote Business",
    },
    content: {
      fr: `## Connectez Tipote à votre CRM Tipote Business

### Configuration

1. **Paramètres > Connexions** → Section Tipote Business
2. Entrez votre **clé API Tipote Business**
3. Sauvegardez

### Ce que vous pouvez faire

- **Exporter les leads** de vos quiz et pages vers Tipote Business
...
- **Acheter des crédits** supplémentaires via Tipote Business

### Templates Tipote Business

Tipote propose aussi une bibliothèque de **templates Tipote Business** téléchargeables et personnalisables via l'IA (accessible depuis **Templates** dans la sidebar).

> **Voir aussi :** [Gérer vos leads](/support/article/manage-leads) • [Templates Tipote Business](/support/article/systemeio-templates)`,
      en: `## Connect Tipote to Tipote Business

Go to **Settings > Connections**, enter your Tipote Business API key. Export leads, add capture tags, auto-sync.

> **See also:** [Manage leads](/support/article/manage-leads) • [Tipote Business templates](/support/article/systemeio-templates)`,
      es: `## Conecta Tipote a Tipote Business

Ve a **Configuración > Conexiones**, introduce tu API key de Tipote Business. Exporta leads y sincroniza.`,
      it: `## Collega Tipote a Tipote Business

Vai in **Impostazioni > Connessioni**, inserisci la tua API key Tipote Business. Esporta lead e sincronizza.`,
      ar: `## ربط Tipote بـ Tipote Business

اذهب إلى **الإعدادات > الاتصالات**، أدخل مفتاح API الخاص بـ Tipote Business. صدّر العملاء المحتملين وزامن.`,
    },
  ...
  },
  {
    ...
    sort_order: 3,
    title: {
      fr: "Templates Tipote Business",
      en: "Tipote Business Templates",
      es: "Templates de Tipote Business",
      it: "Templates Tipote Business",
      ar: "قوالب Tipote Business",
    },
    content: {
...
- **Téléchargement direct** dans votre compte Tipote Business
...
> **Voir aussi :** [Intégration Tipote Business](/support/article/systemeio-integration) • [Hub de création](/support/article/create-content-overview)`,
      en: `## Ready-to-use templates

Access: **Templates** in sidebar. Preview, download, customize with AI, and import into Tipote Business.

> **See also:** [Tipote Business integration](/support/article/systemeio-integration)`,
...
الوصول من **القوالب** في الشريط الجانبي. معاينة وتنزيل وتخصيص باستخدام الذكاء الاصطناعي.`,
  ...
  // ── Tipote Business overview article ──
  {
    category_slug: "leads-crm",
    slug: "tipote-business-overview",
    sort_order: 0,
    title: {
      fr: "Tipote Business — Votre plateforme tout-en-un",
      en: "Tipote Business — Your all-in-one platform",
      es: "Tipote Business — Tu plataforma todo-en-uno",
      it: "Tipote Business — La tua piattaforma tutto-in-uno",
      ar: "Tipote Business — منصتك المتكاملة",
    },
    content: {
      fr: `## Qu'est-ce que Tipote Business ?

**Tipote Business** est votre plateforme business complète, incluse dans votre abonnement Tipote (plans Basic, Pro et Elite). Elle vous donne accès à :

- **Tunnels de vente** — Créez des pages de capture, de vente et de remerciement
- **Emailing & newsletters** — Envoyez des séquences email automatisées et des newsletters
- **Pages & sites web** — Construisez des pages professionnelles sans coder
- **Paiement & encaissement** — Vendez vos produits et services directement
- **Formations en ligne** — Hébergez et vendez vos cours
- **Programme d'affiliation** — Lancez votre propre programme d'affiliation
- **Webinaires** — Organisez des événements en direct (Pro et Elite)

### Comment y accéder ?

Cliquez sur **Tipote Business** dans la sidebar de Tipote App. La plateforme s'ouvre dans un nouvel onglet.

### Différences par plan

| | Basic (19€) | Pro (49€) | Elite (99€) |
|---|---|---|---|
| Tunnels | 10 | 50 | Illimité |
| Contacts email | 5 000 | 10 000 | Illimité |
| Webinaires | Non | Oui | Oui |

### Tipote App vs Tipote Business

- **Tipote App** = IA qui crée (contenu, stratégie, publication réseaux sociaux)
- **Tipote Business** = Plateforme qui vend (tunnels, emails, pages, paiements, formations)

Les deux travaillent ensemble : créez du contenu avec Tipote App, publiez et vendez avec Tipote Business.

> **Voir aussi :** [Intégration Tipote Business](/support/article/systemeio-integration) • [Les plans et tarifs](/support/article/plans-overview)`,
      en: `## What is Tipote Business?

**Tipote Business** is your complete business platform, included in your Tipote subscription (Basic, Pro and Elite plans). It gives you access to:

- **Sales funnels** — Create capture, sales and thank you pages
- **Emailing & newsletters** — Send automated email sequences and newsletters
- **Pages & websites** — Build professional pages without coding
- **Payments & checkout** — Sell your products and services directly
- **Online courses** — Host and sell your courses
- **Affiliate program** — Launch your own affiliate program
- **Webinars** — Host live events (Pro and Elite)

### How to access it?

Click on **Tipote Business** in the Tipote App sidebar. The platform opens in a new tab.

### Tipote App vs Tipote Business

- **Tipote App** = AI that creates (content, strategy, social media publishing)
- **Tipote Business** = Platform that sells (funnels, emails, pages, payments, courses)

> **See also:** [Tipote Business integration](/support/article/systemeio-integration) • [Plans and pricing](/support/article/plans-overview)`,
      es: `## ¿Qué es Tipote Business?

**Tipote Business** es tu plataforma de negocio completa, incluida en tu suscripción Tipote (planes Basic, Pro y Elite).

Accede haciendo clic en **Tipote Business** en la sidebar de Tipote App.

> **Ver también:** [Integración Tipote Business](/support/article/systemeio-integration) • [Planes y precios](/support/article/plans-overview)`,
      it: `## Cos'è Tipote Business?

**Tipote Business** è la tua piattaforma business completa, inclusa nel tuo abbonamento Tipote (piani Basic, Pro ed Elite).

Accedi cliccando su **Tipote Business** nella sidebar di Tipote App.

> **Vedi anche:** [Integrazione Tipote Business](/support/article/systemeio-integration) • [Piani e prezzi](/support/article/plans-overview)`,
      ar: `## ما هو Tipote Business؟

**Tipote Business** هو منصة الأعمال الكاملة الخاصة بك، المضمنة في اشتراكك في Tipote (خطط Basic و Pro و Elite).

للوصول إليها، انقر على **Tipote Business** في الشريط الجانبي لتطبيق Tipote.`,
    },
    related_slugs: ["systemeio-integration", "plans-overview", "systemeio-templates"],
    tags: ["tipote-business", "platform", "funnels", "email", "payments"],
  },
  // ═══════════════════════════════════════════════════════════════════
...
3. Vous êtes redirigé vers **Tipote Business** pour le paiement
...
2. Vous êtes redirigé vers Tipote Business pour le paiement
...
Les **toast widgets** sont des petites notifications pop-up qui s'affichent sur vos pages (site, landing page, page Tipote Business) pour montrer l'activité récente et renforcer la confiance.
...
> ⚠️ **Important :** Si vous avez un abonnement actif, annulez-le d'abord sur Tipote Business pour éviter d'être facturé.
...
Export your data first. Cancel active subscriptions on Tipote Business.
