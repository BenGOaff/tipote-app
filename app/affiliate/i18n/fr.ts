...
export const FR: AffiliateDict = {
  ...
  overview: {
    ...
    promote_tiquiz_pitch: "Le logiciel de création de quiz. Deux niveaux : 9 €/mois pour un solo ou un seul projet, 29 €/mois pour les agences, les freelances qui vendent des quiz à leurs clients et les multi-projets. Sur les abonnements, tu touches ta commission sur les 12 premiers mois de chaque client.",
  ...
  link_destinations: {
    ...
    tiquiz_monthly_label: "Tiquiz mensuel (9 €/mois)",
    ...
    tiquiz_yearly_label: "Tiquiz annuel (90 €/an)",
  ...
  revenus: {
    ...
    calculator_plan_simple: "Accès simple, 9 €/mois",
  ...
  support: {
    ...
    faq_subscriptions_a: "Oui, sur les 12 premiers mois d'abonnement de chaque client. Un client sur l'accès simple à 9 €/mois te rapporte 3,60 € par mois, soit 43,20 € sur l'année. Un client sur le Plus à 29 €/mois te rapporte 11,60 € par mois, soit 139,20 € sur l'année. C'est pour ça qu'il vaut le coup de parler du Plus aux agences, aux freelances qui vendent des prestations de quiz et aux gens qui gèrent plusieurs projets.",
    ...
    faq_avg_earnings_a: "L'Atelier du Quiz est à 47 € en paiement unique : ta commission de 70% fait 32,90 € par vente. L'abonnement Tiquiz mensuel est à 9 €/mois : ta commission de 40% fait 3,60 € par mois et par client sur ses 12 premiers mois, soit 43,20 € pour un abonné qui reste l'année. Et si ton filleul prend le Plus à 29 €/mois (agence, freelance qui vend des quiz à ses clients, plusieurs projets), c'est 11,60 € par mois, soit 139,20 € sur l'année. Les formules annuelles existent aussi : 90 € pour l'accès simple, 290 € pour le Plus. Je ne publie pas de revenu moyen par affilié : le programme est jeune, je préfère te donner le calcul exact plutôt qu'une moyenne qui ne veut rien dire. Le simulateur de l'onglet Revenus fait le calcul pour toi.",
