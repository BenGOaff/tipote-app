...
export const FR: AffiliateDict = {
  ...
  promouvoir: {
    ...
    warning_naked_url_body: "Cette page n'est PAS paramétrée affiliation côté Systeme.io. Même en ajoutant ton ?sa=, le lien ne traque RIEN et tu ne touches AUCUNE commission. Ne l'utilise jamais : prends toujours un des liens ci-dessous (eux sont bien tagués).",
    tab_links: "Liens",
    tab_emails: "Emails",
    tab_posts: "Réseaux",
    tab_visuels: "Visuels",
  ...
  content_space: {
    ...
    folder_hint: "Ton identifiant affilié ?sa={sa} est injecté automatiquement dans tous les liens de ce dossier. Tu n'as jamais à l'ajouter à la main.",
  ...
  links_manager: {
    ...
    destination_hint: "Un chemin {host} (ex. /commande) ou une URL complète. Ton ?sa={sa} est ajouté automatiquement.",
    save: "Enregistrer",
    cancel: "Annuler",
