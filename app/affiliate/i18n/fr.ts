...
export const FR: AffiliateDict = {
  ...
  support: {
    ...
    faq_subscriptions_a: "Oui, sur les 12 premiers mois d'abonnement de chaque client. Un client sur l'accès simple à 17 €/mois te rapporte 6,80 € par mois, soit 81,60 € sur l'année. Un client sur le Plus à 29 €/mois te rapporte 11,60 € par mois, soit 139,20 € sur l'année. C'est pour ça qu'il vaut le coup de parler du Plus aux agences, aux freelances qui vendent des prestations de quiz et aux gens qui gèrent plusieurs projets.",
    ...
    faq_avg_earnings_a: "L'Atelier du Quiz est à 47 € en paiement unique : ta commission de 70% fait 32,90 € par vente. L'abonnement Tiquiz mensuel est à 17 €/mois : ta commission de 40% fait 6,80 € par mois et par client sur ses 12 premiers mois, soit 81,60 € pour un abonné qui reste l'année. Et si ton filleul prend le Plus à 29 €/mois (agence, freelance qui vend des quiz à ses clients, plusieurs projets), c'est 11,60 € par mois, soit 139,20 € sur l'année. Les formules annuelles existent aussi : 170 € pour l'accès simple, 290 € pour le Plus. Je ne publie pas de revenu moyen par affilié : le programme est jeune, je préfère te donner le calcul exact plutôt qu'une moyenne qui ne veut rien dire. Le simulateur de l'onglet Revenus fait le calcul pour toi.",
