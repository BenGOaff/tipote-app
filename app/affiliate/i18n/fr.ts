...
export const FR: AffiliateDict = {
  ...
  link_destinations: {
    ...
    tiquiz_monthly_description: "Quiz et réponses illimités, sans engagement.",
    tiquiz_monthly_plus_label: "Tiquiz mensuel Plus",
    tiquiz_monthly_plus_description: "Multi-profils, analyse IA, multi-clés API.",
    tiquiz_yearly_label: "Tiquiz annuel (90 €/an)",
    tiquiz_yearly_description: "2 mois offerts vs mensuel.",
    tiquiz_yearly_plus_label: "Tiquiz annuel Plus",
    tiquiz_yearly_plus_description: "Le Plus, paiement annuel avec mois offerts.",
  ...
  revenus: {
    ...
    calculator_assumptions: "Base de calcul : L'Atelier du Quiz à {atelier} en paiement unique (commission 70%), abonnement Tiquiz mensuel à {tiquiz} (commission 40% sur les 12 premiers mois de chaque client). Les plans annuels et Plus rapportent davantage, on prend le moins cher pour ne pas gonfler le résultat. Un abonné ramené en janvier te paie encore en décembre : c'est ce qui fait grossir le total sur l'année.",
  },
  paiement: {
    page_title: "Paiement",
    page_subtitle_sio:
  ...
  support: {
    ...
    faq_subscriptions_a: "Oui, sur les 12 premiers mois d'abonnement de chaque client. Si tu amènes un client qui prend l'offre mensuelle à 9 €/mois, tu touches ta commission (40%) sur chacun des 12 premiers paiements, soit environ 43 €/an par client mensuel.",
