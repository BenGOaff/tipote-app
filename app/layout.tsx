...
export default async function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    <html lang={locale} dir={dir} suppressHydrationWarning>
      ...
      <link
        rel="stylesheet"
        href="https://fonts.googleapis.com/css2?family=Anton&family=Archivo+Black&family=Bebas+Neue&family=Caveat:wght@600;700&family=Montserrat:wght@600;700;800&family=Roboto:wght@700;900&display=swap"
      />
