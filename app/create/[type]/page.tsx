    ...
    <AppShell userEmail={userEmail}>
      <div className="space-y-6">
        <div className="flex items-start justify-between gap-4">
          <div>
            <p className="text-xs font-semibold text-slate-500 dark:text-slate-400">{t("createLabel")}</p>
            <h1 className="mt-1 text-xl md:text-2xl font-semibold text-slate-900 dark:text-slate-50">{meta.label}</h1>
            <p className="mt-1 text-sm text-slate-500 dark:text-slate-400 max-w-2xl">{meta.hint}</p>
