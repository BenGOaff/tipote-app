  ...
  if (noApiKey) {
    return (
      <div className={`flex items-start gap-2 rounded-lg border px-3 py-2 text-xs ${
        isDark ? "border-amber-500/30 bg-amber-500/10 text-amber-300" : "border-amber-300 dark:border-amber-700 bg-amber-50 dark:bg-amber-950/30 text-amber-700 dark:text-amber-300"
      }`}>
