...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      components={{
        // Version compatible avec react-day-picker v9 :
        // on remplace IconLeft/IconRight par un Chevron custom.
        Chevron: ({ orientation, ...chevronProps }) => {
          ...
          // Pour les orientations "up"/"down" éventuelles (dropdown),
          // on réutilise la flèche droite par défaut.
          return <ChevronRight className="h-4 w-4" {...chevronProps} />;
        },
      }}
      {...props}
