...
export default function AnalyticsLovableClient() {
  ...
  return (
    <DashboardLayout title="Analytics" showAnalyticsLink={false} contentClassName="p-6 space-y-6 max-w-5xl mx-auto">
      {/* Header */}
      <div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-3 text-sm">
                        <div>
                          ...
                          <p className="font-medium">{(metric.revenue || 0).toLocaleString("fr-FR")}€</p>
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <p className="font-medium">{(metric.conversion_rate || 0).toFixed(1)}%</p>
                        </div>
                        <div>
